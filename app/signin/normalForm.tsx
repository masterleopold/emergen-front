        ...
        <div className="">
            ...
            useEmailLogin && <>
              {/* <div className="relative mt-6">
                <div className="absolute inset-0 flex items-center" aria-hidden="true">
                  <div className="w-full border-t-[0.5px] border-gray-300" />
                </div>
                ...
                <div className='mb-5'>
                  ...
                  <div className="relative mt-1">
                    <input
                      ...
                      className={'appearance-none block w-full rounded-lg pl-[14px] px-3 py-3 bg-gray-200 hover:bg-gray-100 hover:border-gray-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500 placeholder-gray-500 caret-primary-600 sm:text-sm pr-10'}
                    />
                  </div>
                </div>
          ...
          <div className="w-hull text-center block mt-2 text-xs text-gray-600">
            ...
            <Link
              ...
              href='https://vox.delivery/terms'
            >{t('login.tos')}</Link>
            &nbsp;&&nbsp;
            <Link
              className='text-primary-600'
              target='_blank' rel='noopener noreferrer'
              href='https://vox.delivery/privacy'
            >{t('login.pp')}</Link>
          </div>
