...
const Header: FC = () => {
  ...
  return (
    <div
      className='absolute top-0 left-0 z-10 flex items-center justify-between w-full px-4 h-16'
      style={{
        background: 'linear-gradient(180deg, #FBFBFC 0%, rgba(249, 250, 251, 0.00) 100%)',
      }}
    >
      <div>
        {
      ...
      }
      {
        viewHistory && (
          <div className='flex items-center'>
            ...
            <div className='mx-2 w-[1px] h-3.5 bg-gray-400'></div>
            <Button
              variant='primary'
              className='mr-2 h-8'
