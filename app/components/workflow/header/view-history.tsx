    ...
    (
      ...
      >
        <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)}>
          {
            withText && (
              <div className={cn(
                'flex items-center px-3 h-8 rounded-lg border-[0.5px] border-gray-300 bg-white shadow-xs',
          ...
          }
          {
            !withText && (
              ...
              >
                <div
                  className={`
                    flex items-center justify-center w-7 h-7 rounded-md hover:bg-gray-300 cursor-pointer
                    ${open && 'bg-primary-50'}
                  `}
                  onClick={() => {
                    setCurrentLogItem()
        ...
        <PortalToFollowElemContent className='z-[12]'>
          <div
            className='flex flex-col ml-2 w-[240px] bg-white border-[0.5px] border-gray-300 shadow-xl rounded-xl overflow-y-auto'
            style={{
