  ...
  return (
    <>
      ...
      </div>
      {
        isRunning && (
          <div
            className='flex items-center justify-center ml-0.5 w-7 h-7 cursor-pointer hover:bg-gray-300 rounded-md'
...
const RunAndHistory: FC = () => {
  ...
  return (
    <div className='flex items-center px-0.5 h-8 rounded-lg border-[0.5px] border-gray-300 bg-white'>
      {
        !isChatMode && <RunMode />
      }
      {
      ...
      <div className='mx-0.5 w-[0.5px] h-3.5 bg-divider-regular'></div>
      <ViewHistory />
    </div>
  )
}
