...
const RunningTitle = () => {
  ...
  return (
    <div className='flex items-center h-[18px] text-xs text-gray-500'>
      ...
      <span className='ml-1 uppercase flex items-center px-1 h-[18px] rounded-[5px] border-[0.5px] border-primary-300 bg-white/[0.48] text-[10px] font-semibold text-primary-600'>
