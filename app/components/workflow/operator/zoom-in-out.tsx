  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger asChild onClick={handleTrigger}>
        <div className={`
          p-0.5 h-9 cursor-pointer text-[13px] text-gray-500 font-medium rounded-lg bg-white border-[0.5px] border-gray-100
          ${workflowReadOnly && '!cursor-not-allowed opacity-50'}
        `}>
          <div className={cn(
            'flex items-center justify-between w-[98px] h-8 hover:bg-gray-50 rounded-md',
            open && 'bg-gray-50',
          )}>
            <TipPopup
            ...
            >
              <div
                className='flex items-center justify-center w-8 h-8 rounded-lg cursor-pointer hover:bg-gray-200'
                onClick={(e) => {
                  e.stopPropagation()
                  zoomOut()
                }}
