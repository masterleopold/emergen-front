    ...
    <div className='mt-2'>
      <div className='px-4 pb-4 space-y-4'>
        <Field
          ...
          operations={(
            <div className='flex items-center h-[18px] px-1 border-[0.5px] border-black/8 rounded-[5px] text-xs font-medium text-gray-500 capitalize'>Array</div>
          )}
        >
          <VarReferencePicker
            readonly={readOnly}
      ...
      {isShowSingleRun && (
        <BeforeRunForm
          ...
          result={
            <div className='mt-3'>
              <div className='px-4'>
                <div className='flex items-center h-[34px] justify-between px-3 bg-gray-100 border-[0.5px] border-gray-300 rounded-lg cursor-pointer' onClick={showIterationDetail}>
