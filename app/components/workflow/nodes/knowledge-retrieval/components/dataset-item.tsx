...
const DatasetItem: FC<Props> = ({
  ...
  return (
    <div className='flex items-center h-10 justify-between rounded-xl px-2 bg-white border-[0.5px] border-gray-300  cursor-pointer group/dataset-item'>
      <div className='w-0 grow flex items-center space-x-1.5'>
        {
          payload.data_source_type === DataSourceType.NOTION
            ...
            : <div className='shrink-0 flex items-center justify-center w-6 h-6 bg-[#F8F4FE] rounded-md border-[0.5px] border-[#F8F4FE]'>
      ...
      {!readonly && (
        <div className='hidden group-hover/dataset-item:flex shrink-0 ml-2  items-center space-x-1'>
          <div
            className='flex items-center justify-center w-6 h-6 hover:bg-gray-300 rounded-md cursor-pointer'
