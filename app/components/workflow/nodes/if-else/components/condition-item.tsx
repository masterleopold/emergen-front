      ...
      {isShowLogicalOperator && (
        <div className='flex items-center justify-center select-none'>
          <div className='flex items-center '>
            {Line}
            <div
              className='shrink-0 mx-1 flex items-center h-[22px] pl-2 pr-1.5 border-[0.5px] border-gray-300 rounded-lg bg-white shadow-xs space-x-0.5 text-primary-600 cursor-pointer'
