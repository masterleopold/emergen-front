  ...
  return (
    <div className='border border-gray-300 rounded-lg overflow-hidden'>
      <div className='flex items-center h-7 leading-7 text-xs font-medium text-gray-500 uppercase'>
        <div className='w-1/2 h-full pl-3 border-r-[0.5px] border-gray-300'>{t(`${i18nPrefix}.key`)}</div>
        <div className='flex w-1/2 h-full pl-3 pr-1 items-center justify-between'>
          ...
          {/* {!readonly && (
            ...
            >
              <div
                className='p-1 cursor-pointer rounded-md hover:bg-gray-300 text-gray-500 hover:text-gray-800'
