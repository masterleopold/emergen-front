...
const ObjectChildren: FC<ObjectChildrenProps> = ({
  ...
  // absolute top-[-2px]
  return (
    <div ref={itemRef} className=' bg-white rounded-lg border-[0.5px] border-gray-300 shadow-2xl space-y-1' style={{
    ...
    <>
      {
        !hideSearch && (
          <>
            <div
              className={cn(searchBoxClassName, isFocus && 'bg-white', 'mb-2 mx-1 flex items-center px-2 rounded-lg bg-gray-100 ')}
            ...
            <div className='h-[0.5px] bg-gray-300 relative left-[-4px]' style={{
              width: 'calc(100% + 8px)',
            }}></div>
          </>
        )
