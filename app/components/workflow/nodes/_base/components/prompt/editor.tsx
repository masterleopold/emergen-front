                  ...
                  <TooltipPlus
                    popupContent={
                      <div>
                        ...
                        <a className='text-[#7C3AED]' target='_blank' href='https://jinja.palletsprojects.com/en/2.10.x/'>{t('workflow.common.learnMore')}</a>
                      </div>
                    }
                    hideArrow
                  >
                    <div className={cn(editionType === EditionType.jinja2 && 'border-gray-300 bg-white', 'flex h-[22px] items-center px-1.5 rounded-[5px] border-[0.5px] border-transparent hover:border-gray-300 space-x-0.5')}>
