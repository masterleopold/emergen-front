...
const BasePanel: FC<BasePanelProps> = ({
  ...
  return (
    <div className={cn(
      ...
      showMessageLogModal && '!absolute !mr-0 w-[384px] overflow-hidden -top-[5px] right-[416px] z-0 shadow-lg border-[0.5px] border-gray-300 rounded-2xl transition-all',
    )}>
      <div
        ref={triggerRef}
      ...
      <div
        ref={containerRef}
        className={cn('relative h-full bg-white shadow-lg border-[0.5px] rounded-2xl', showSingleRunPanel ? 'overflow-hidden' : 'overflow-y-auto')}
        style={{
          width: `${panelWidth}px`,
        }}
      >
        <div className='sticky top-0 bg-white border-b-[0.5px] border-gray-300 z-10'>
            ...
            <div className='shrink-0 flex items-center text-gray-500'>
              {
                canRunBySingle(data.type) && !nodesReadOnly && (
                  ...
                  >
                    <div
                      className='flex items-center justify-center mr-1 w-6 h-6 rounded-md hover:bg-gray-300 cursor-pointer'
                      onClick={() => {
              ...
              <div className='mx-3 w-[1px] h-3.5 bg-gray-300' />
              <div
