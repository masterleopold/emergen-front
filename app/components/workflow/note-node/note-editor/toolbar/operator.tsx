  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(!open)}>
        <div
          className={cn(
            'flex items-center justify-center w-8 h-8 cursor-pointer rounded-lg hover:bg-gray-300',
            open && 'bg-gray-300',
          )}
        >
      ...
      <PortalToFollowElemContent>
        <div className='min-w-[192px] bg-white rounded-md border-[0.5px] border-gray-300 shadow-xl'>
          <div className='p-1'>
            <div
              className='flex items-center justify-between px-3 h-8 cursor-pointer rounded-md text-sm text-gray-700 hover:bg-gray-300'
              onClick={() => {
                onCopy()
                setOpen(false)
              }}
