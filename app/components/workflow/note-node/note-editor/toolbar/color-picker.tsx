  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(!open)}>
        <div className={cn(
          'flex items-center justify-center w-8 h-8 rounded-md cursor-pointer hover:bg-gray-300',
          open && 'bg-gray-300',
        )}>
          <div
            className='w-4 h-4 rounded-full border-[0.5px] border-gray-300'
        ...
        <div className='grid grid-cols-3 grid-rows-2 gap-0.5 p-0.5 rounded-lg border-[0.5px] border-black/8 bg-white shadow-lg'>
          {
            COLOR_LIST.map(color => (
              ...
              >
                ...
                ></div>
                <div
                  className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-[0.5px] border-gray-300'
