    ...
    <>
      {
        elements.reference && (
          <FloatingPortal root={containerElement}>
            <div
              className={cn(
                'nodrag nopan inline-flex items-center w-max rounded-md border-[0.5px] border-gray-300 bg-white z-10',
                !linkOperatorShow && 'p-1 shadow-md',
                linkOperatorShow && 'p-0.5 text-xs text-gray-500 font-medium',
              )}
