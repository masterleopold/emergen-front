...
const CreateAppModal = ({ show, onSuccess, onClose }: CreateAppDialogProps) => {
  ...
  const [emoji, setEmoji] = useState({ icon: '◾', icon_background: '#F8F4FE' })
    ...
    >
      ...
      <div className='py-2 px-8'>
        ...
        <div className='flex'>
          ...
          >
            <div
              className={cn(
                'relative grow box-border w-[158px] mr-2 px-0.5 pt-3 pb-2 flex flex-col items-center justify-center gap-1 rounded-xl border-[0.5px] border-gray-300 bg-white text-gray-700 cursor-pointer hover:border-gray-300',
            ...
            >
              <ChatBot className='w-6 h-6 text-[#7C3AED]' />
          ...
          >
            <div
              className={cn(
                'relative grow box-border w-[158px] mr-2 px-0.5 pt-3 pb-2 flex flex-col items-center justify-center gap-1 rounded-xl border-[0.5px] border-gray-300 text-gray-700 cursor-pointer bg-white hover:border-gray-400',
          ...
          >
            ...
            >
              <CuteRobote className='w-6 h-6 text-primary-600' />
          ...
          >
            <div
              className={cn(
                'relative grow box-border w-[158px] px-0.5 pt-3 pb-2 flex flex-col items-center justify-center gap-1 rounded-xl border-[0.5px] border-gray-300 text-gray-700 cursor-pointer bg-white hover:border-gray-400',
                s['grid-bg-workflow'],
            ...
            >
              ...
              <span className='absolute top-[-3px] right-[-3px] px-1 rounded-[5px] bg-white border-[0.5px] border-black/8 text-gray-500 text-[10px] leading-[18px] font-medium'>BETA</span>
            </div>
          </TooltipPlus>
        </div>
      </div>
      {showChatBotType && (
        <div className='py-2 px-8'>
          ...
          <div className='flex gap-2'>
            <div
              className={cn(
                'relative grow flex-[50%] pl-4 py-[10px] pr-[10px] rounded-xl border-[0.5px] border-gray-300 bg-gray-100 text-gray-700 cursor-pointer hover:bg-white hover:border-gray-400',
                appMode === 'chat' && 'bg-white border-[1.5px] border-primary-400 hover:border-[1.5px] hover:border-primary-400',
              )}
              onClick={() => {
                setAppMode('chat')
              }}
            >
              <div className='flex items-center justify-between'>
                ...
                <div className='group'>
                  <RiQuestionLine className='w-[14px] h-[14px] text-gray-500 hover:text-gray-500' />
                  <div
                    className={cn(
                      'hidden z-20 absolute left-[327px] top-[-158px] w-[376px] rounded-xl bg-white border-[0.5px] border-[rgba(0,0,0,0.05)] shadow-2xl group-hover:block',
                    )}
                  >
            ...
            <div
              className={cn(
                'relative grow flex-[50%] pl-3 py-2 pr-2 rounded-lg border-[0.5px] border-gray-300 bg-gray-100 text-gray-700 cursor-pointer hover:bg-white hover:border-gray-300',
            ...
            >
              <div className='flex items-center justify-between'>
                <div className='flex items-center'>
                  ...
                  <span className='px-1 rounded-[5px] bg-white border-[0.5px] border-black/8 text-gray-500 text-[10px] leading-[18px] font-medium'>BETA</span>
                </div>
                <div className='group'>
                  <RiQuestionLine className='w-[14px] h-[14px] text-gray-500 hover:text-gray-500' />
                  <div
                    className={cn(
                      'hidden z-20 absolute right-[26px] top-[-158px] w-[376px] rounded-xl bg-white border-[0.5px] border-[rgba(0,0,0,0.05)] shadow-2xl group-hover:block',
                    )}
                  >
                    <div className='px-4 py-4'>
                      <div className='flex items-center justify-between'>
      ...
      <div className='pt-2 px-8'>
        ...
        {showEmojiPicker && <EmojiPicker
          ...
          onClose={() => {
            setEmoji({ icon: '🤖', icon_background: '#D9C7FA' })
            setShowEmojiPicker(false)
          }}
        />}
      </div>
      ...
      <div className='pt-2 px-8'>
        ...
        <textarea
          className='w-full px-3 py-2 text-sm font-normal bg-gray-100 rounded-lg border-[0.5px] border-transparent outline-none appearance-none caret-primary-600 placeholder:text-gray-400 hover:bg-gray-50 hover:border hover:border-gray-300 focus:bg-gray-50 focus:border focus:border-gray-300 h-[80px] resize-none'
