...
const VarPanel: FC<Props> = ({
  ...
  return (
    <div className='rounded-xl border-[0.5px] border-color-primary-100 bg-primary-25'>
      <div
      ...
      >
        {
          isCollapse
            ? <RiArrowRightSLine className='w-3 h-3 text-gray-400' />
            : <RiArrowDownSLine className='w-3 h-3 text-gray-400' />
        }
        <div className='text-sm font-semibold text-primary-800 uppercase'>{t('appLog.detail.variables')}</div>
      </div>
      {!isCollapse && (
