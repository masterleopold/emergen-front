    ...
    <>
      ...
      >
        ...
        <div className='flex mt-2'>
          ...
          />
          <input className={`flex-grow rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-200`}
        ...
        <textarea
          rows={3}
          className={`mt-2 pt-2 pb-2 px-3 rounded-lg bg-gray-200 w-full ${s.settingsTip} text-gray-900`}
        ...
        {isChat && <> <div className={`mt-8 font-medium ${s.settingTitle} text-gray-900`}>{t(`${prefixSettings}.chatColorTheme`)}</div>
           ...
           <input className={`w-full mt-2 rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-200`}
        ...
        {isShowMore && <>
          ...
          <p className={`mt-1 ${s.settingsTip} text-gray-500`}>
            <Trans
              ...
              components={{ privacyPolicyLink: <Link href={'https://docs.vox.delivery/user-agreement/privacy-policy'} target='_blank' rel='noopener noreferrer' className='text-primary-600' /> }}
            />
          </p>
          <input className={`w-full mt-2 rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-200`}
