...
function AppCard({
  ...
  return (
    <div
      className={`border-[0.5px] rounded-xl border-gray-300 ${className ?? ''
      }`}
    >
      <div className={`px-6 py-5 ${customBgColor ?? bgColor} rounded-xl`}>
        ...
        <div className="flex flex-col justify-center py-2">
          <div className="py-1">
            ...
            <div className="w-full h-9 pl-2 pr-0.5 py-0.5 bg-black bg-opacity-2 rounded-lg border-[0.5px] border-black border-opacity-5 justify-start items-center inline-flex">
        ...
        <div className={'pt-2 flex flex-row items-center flex-wrap gap-y-2'}>
          {!isApp && <SecretKeyButton className='flex-shrink-0 bg-white mr-2' textCls='!text-gray-700 font-medium' iconCls='stroke-[1.2px]' appId={appInfo.id} />}
