...
const NoData: FC<INoDataProps> = ({
  ...
  return (
    <div className='mt-[60px] px-5 py-5 rounded-2xl bg-gray-100 '>
      <div className='flex items-center justify-center w-11 h-11 border-[0.5px] border-gray-400 rounded-lg'>
        {markIcon}
      </div>
      <div className='mt-2'>
