...
const CacheCtrlBtn: FC<Props> = ({
  ...
  return (
    <div className={cn(className, 'flex items-center')}>
      <div className='inline-flex p-0.5 space-x-0.5 rounded-lg bg-white border-[0.5px] border-gray-300 text-gray-500 cursor-pointer'>
        {cached
          ? (
            <div>
              <div
                ref={cachedBtnRef}
                className={cn(isCachedBtnHovering ? 'bg-[#FEF3F2] text-[#D92D20]' : 'bg-[#F8F4FE] text-[#681CEA]', 'flex p-1 space-x-1 items-center rounded-md leading-4 text-xs font-medium')}
          ...
          : answer
            ? (
              ...
              >
                <div
                  className='p-1 rounded-md hover:bg-[#F8F4FE] hover:text-[#681CEA] cursor-pointer'
                  onClick={handleAdd}
                >
