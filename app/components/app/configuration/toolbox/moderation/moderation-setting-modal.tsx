...
const ModerationSettingModal: FC<ModerationSettingModalProps> = ({
  ...
  return (
    ...
    >
      <div className='mb-2 text-xl font-semibold text-[#373B3F]'>
      ...
      <div className='py-2'>
            ...
            providers.map(provider => (
              <div
                ...
                className={`
                  ...
                  ${localeData.type === provider.key ? 'bg-white border-[1.5px] border-primary-400' : 'border border-gray-100 bg-gray-25'}
        ...
        </div>
        {
          !isLoading && !openaiProviderConfiged && localeData.type === 'openai_moderation' && (
            <div className='flex items-center mt-2 px-3 py-2 bg-[#FFFAEB] rounded-lg border-[0.5px] border-[#FEF0C7]'>
      ...
      </div>
      {
        localeData.type === 'keywords' && (
          <div className='py-2'>
            ...
            <div className='relative px-3 py-3 h-[88px] bg-gray-200 rounded-lg'>
              <textarea
