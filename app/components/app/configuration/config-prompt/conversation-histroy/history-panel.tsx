    ...
    <Panel
      ...
      headerRight={
        <div className='flex items-center'>
          ...
          <div className='ml-3 w-[1px] h-[14px] bg-gray-300'></div>
      ...
      {showWarning && (
        <div className='flex justify-between py-2 px-3 rounded-b-xl bg-[#FFFAEB] text-xs text-gray-700'>
          <div>{t('appDebug.feature.conversationHistory.tip')}
            <a href='https://docs.vox.delivery/features/prompt-engineering'
            target='_blank' rel='noopener noreferrer'
            className='text-[#7C3AED]'>{t('appDebug.feature.conversationHistory.learnMore')}
            </a>
          </div>
        </div>
      )}
