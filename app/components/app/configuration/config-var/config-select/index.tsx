  ...
  return (
    <div>
            ...
            {options.map((o, index) => (
              <div className={`${s.inputWrap} relative`} key={index}>
                ...
                <input
                  ...
                  className={'w-full pl-1.5 pr-8 text-sm leading-9 text-gray-900 border-0 grow h-11 bg-transparent focus:outline-none cursor-pointer'}
                />
                <RemoveIcon
      ...
      <div
        ...
        className='flex items-center h-11 px-3 gap-2 rounded-lg cursor-pointer text-gray-400 bg-gray-200'>
