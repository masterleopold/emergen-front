...
const PARAGRAPH_MAX_LENGTH = 1032 * 64
...
const inputClassName = 'w-full px-3 text-sm leading-9 text-gray-900 border-0 rounded-lg grow h-11 bg-gray-100 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200'
