    ...
    >
      <>
        <div className="flex flex-col h-full">
          <div className='relative flex grow h-[200px] pt-16'>
            {/* Header */}
              ...
              <div className='flex items-center justify-between px-6 py-6'>
                <div className='flex items-center'>
                  ...
                  <div className='flex items-center h-[14px] space-x-1 text-xs'>
                    {isAdvancedMode && (
                      <div className='ml-1 flex items-center h-5 px-1.5 border-[0.5px] border-gray-100 rounded-md text-[11px] font-medium text-gray-500 uppercase'>{t('appDebug.promptMode.advanced')}</div>
                    )}
                  </div>
                </div>
                <div className='flex items-center'>
                  ...
                  {!debugWithMultipleModel && (
                    <>
                      ...
                      />
                      <div className='mx-2 w-[1px] h-[14px] bg-gray-300'></div>
                    </>
                  )}
                  {isMobile && (
            ...
            <div className={`pt-4 w-full sm:w-1/2 shrink-0 flex flex-col h-full ${debugWithMultipleModel && 'max-w-[560px]'}`}>
              <Config />
            </div>
            {!isMobile && <div className="relative flex flex-col w-1/2 h-full overflow-y-auto grow mt-4" style={{ borderColor: 'rgba(0, 0, 0, 0.02)' }}>
              <div className='flex flex-col h-0 border-t-[0.5px] border-l-[0.5px] grow rounded-tl-2xl bg-gray-100 '>
                <Debug
