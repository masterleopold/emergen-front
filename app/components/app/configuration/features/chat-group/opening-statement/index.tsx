...
const OpeningStatement: FC<IOpeningStatementProps> = ({
    ...
    return isFocus ? (
            ...
            return (
              <div className='group relative rounded-lg border-[0.5px] border-gray-300 flex items-center pl-2.5 hover:border-gray-300 hover:bg-white' key={index}>
                ...
                <input
                  ...
                  className={'w-full overflow-x-auto pl-1.5 pr-8 text-sm leading-9 text-gray-900 border-0 grow h-11 bg-transparent focus:outline-none cursor-pointer rounded-lg'}
                />
      ...
      <div className='mt-1.5 flex flex-wrap'>
        {notEmptyQuestions.map((question, index) => {
          return (
            <div key={index} className='mt-1 mr-1 max-w-full truncate last:mr-0 shrink-0 leading-8 items-center px-2.5 rounded-lg border-[0.5px] border-gray-300 bg-white text-[13px] font-normal text-gray-900 cursor-pointer'>
              {question}
            </div>
          )
        })}
  ...
  return (
    <Panel
      className={cn(isShowConfirmAddVar && 'h-[220px]', 'relative mt-4 !bg-gray-100 border-gray-300 border-[0.5px]')}
              ...
              ? (
                <div>
                  <textarea
                    ...
                    className="w-full rounded-lg bg-white text-sm border-0 bg-transparent focus:outline-none p-2 mt-2 "
