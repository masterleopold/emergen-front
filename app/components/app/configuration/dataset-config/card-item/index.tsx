...
const CardItem: FC<ICardItemProps> = ({
  ...
  return (
    <div
      className={
        cn(className, s.card,
          'relative flex items-center rounded-xl  px-3 py-2.5 bg-white border-[0.5px] border-gray-300  cursor-pointer')
      }>
        ...
        <div>
          <div className='flex items-center w-[160px] mr-1'>
            ...
            {!config.embedding_available && (
              ...
              >
                <span className='shrink-0 inline-flex whitespace-nowrap px-1 border-[0.5px] boder-gray-200 rounded-md text-gray-500 text-xs font-normal leading-[18px]'>{t('dataset.unavailable')}</span>
              </Tooltip>
            )}
          </div>
