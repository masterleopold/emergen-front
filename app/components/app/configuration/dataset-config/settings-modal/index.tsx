...
const SettingsModal: FC<SettingsModalProps> = ({
  ...
  return (
    <div
      className='overflow-hidden w-full flex flex-col bg-white border-[0.5px] border-gray-300 rounded-xl shadow-xl'
      style={{
        height: 'calc(100vh - 72px)',
      }}
      ref={ref}
    >
      <div className='shrink-0 flex justify-between pl-6 pr-5 h-16 border-b-[0.5px] border-b-gray-300 py-5'>
      ...
      {/* Body */}
      <div className='p-6 pt-5 border-b-[0.5px] overflow-y-auto pb-[68px]' style={{
        ...
        <div className={cn(rowClass, 'items-center')}>
          ...
          <input
            ...
            className='block px-3 w-full h-11 bg-gray-200 rounded-lg text-sm text-gray-900 outline-none appearance-none'
        ...
        <div className={cn(rowClass)}>
          ...
          <div className='w-full'>
            <textarea
              ...
              className='block px-3 py-3 w-full h-[88px] rounded-lg bg-gray-100 text-sm outline-none appearance-none resize-none'
          ...
          <div className={cn(rowClass)}>
            ...
            <div className='w-full'>
              ...
              <div className='mt-2 w-full text-xs leading-6 text-gray-500'>
                ...
                <span className='text-[#681CEA] cursor-pointer' onClick={() => setShowAccountSettingModal({ payload: 'provider' })}>{t('datasetSettings.form.embeddingModelTipLink')}</span>
              </div>
            </div>
          </div>
        )}
      ...
      {isRetrievalChanged && !isHideChangedTip && (
        <div className='absolute z-10 left-[30px] right-[30px] bottom-[76px] flex h-10 items-center px-3 rounded-lg border-[0.5px] border-[#FEF0C7] bg-[#FFFAEB] shadow-lg justify-between'>
      ...
      <div
        className='sticky z-[5] bottom-0 w-full flex justify-end py-4 px-6 border-t-[0.5px] bg-white '
        style={{
