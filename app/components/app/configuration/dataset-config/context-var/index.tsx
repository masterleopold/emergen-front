...
const ContextVar: FC<Props> = (props) => {
  ...
  return (
    <div className={cn(notSetVar ? 'rounded-bl-xl rounded-br-xl bg-[#FEF0C7] border-[#FEF0C7]' : 'border-gray-300', 'flex justify-between items-center h-12 px-3 border-t-[0.5px] ')}>
