  ...
  return (
    ...
    >
      ...
      <div className='py-2'>
        ...
        <div className='flex items-center'>
          <input
            ...
            className='grow block px-3 h-11 bg-gray-200 rounded-lg text-sm text-gray-900 outline-none appearance-none'
      ...
      </div>
      {
        localeData.type === 'api' && (
          <div className='py-2'>
            <div className='flex justify-between items-center h-11 text-sm font-medium text-gray-900'>
