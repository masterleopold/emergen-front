          ...
          >
            {
              externalDataToolsConfig.length
                ? <Tool03 className='group-hover:hidden w-4 h-4 text-[#681CEA]' />
                : <Tool03 className='w-4 h-4 text-[#681CEA]' />
            }
            {
              !!externalDataToolsConfig.length && (
          ...
          <div className='pb-3'>
            {
              externalDataToolsConfig.map((item, index: number) => (
                <div
                  ...
                  className='group flex items-center mb-1 last-of-type:mb-0 px-2.5 py-2 rounded-lg border-[0.5px] border-gray-300 bg-white shadow-xs'
                >
                  <div className='grow flex items-center'>
                    <AppIcon size='large'
                      className='mr-2 !w-6 !h-6 rounded-md border-[0.5px] border-gray-300'
                      icon={item.icon}
                  ...
                  <div
                    className='hidden group-hover:flex items-center justify-center mr-1 w-6 h-6 hover:bg-gray-300 rounded-md cursor-pointer'
