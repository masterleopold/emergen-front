...
const AgentSetting: FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        className='w-[640px] flex flex-col h-full overflow-hidden bg-white border-[0.5px] border-gray-300 rounded-xl shadow-xl'
      >
        ...
        {/* Body */}
        <div className='grow p-6 pt-5 border-b-[0.5px] overflow-y-auto pb-[68px]' style={{
          ...
          <ItemPanel
            className='mb-4'
            icon={
              <CuteRobote className='w-4 h-4 text-primary-600' />
            }
