...
const AddFeatureBtn: FC<IAddFeatureBtnProps> = ({
  ...
  return (
    <div
      className='absolute z-[9] left-0 right-0 flex justify-center pb-8'
      style={{
    ...
    >
      <div
        ...
        border-[0.5px] border-primary-100 rounded-lg bg-primary-25 hover:bg-primary-50 cursor-pointer
