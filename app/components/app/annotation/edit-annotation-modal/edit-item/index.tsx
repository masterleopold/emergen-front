        ...
        {!isEdit
            ...
            <div>
              {showNewContent && (
                <div className='mt-3'>
                  ...
                  <div className='mt-1 leading-5 text-sm font-normal text-gray-900 p-2 rounded-lg'>{newContent}</div>
                </div>
              )}
              <div className='mt-2 flex items-center'>
                {!readonly && (
                  <div
                    className='flex items-center space-x-1 leading-[18px] text-xs font-medium text-[#7C3AED] cursor-pointer'
                    onClick={(e) => {
                      setIsEdit(true)
                    }}
                  >
          ...
          : (
            <div className='mt-3'>
              <EditTitle title={editTitle} />
              <Textarea
                className='my-2 block w-full leading-5 max-h-none text-sm text-gray-700 outline-none appearance-none resize-none p-2 rounded-md'
                value={newContent}
