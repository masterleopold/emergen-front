        ...
        foot={
          (
            <div>
              ...
              <div className='px-6 flex h-16 items-center justify-between border-t-[0.5px] border-gray-400 bg-gray-200 rounded-bl-xl rounded-br-xl leading-[18px] text-[13px] font-medium text-gray-500'>
                <div
                  className='flex items-center space-x-2'
                >
                  <input type="checkbox" checked={isCreateNext} onChange={() => setIsCreateNext(!isCreateNext)} className="w-4 h-4 rounded border-gray-300 text-primary-700 focus:ring-primary-700" />
