  ...
  return (
    ...
    >
      <div className='relative'>
        ...
        >
          <div className={cn(
            'flex items-center gap-1 h-8 text-gray-700 text-[13px] leading-[18px] cursor-pointer px-2 rounded-lg bg-gray-25 border-gray-300 border-[0.5px] hover:bg-gray-200',
            ...
            {value === 'chatbot' && (
              <>
                <div className='w-4 h-4 p-[1px]'>
                  <ChatBot className='w-3.5 h-3.5 text-[#7C3AED]' />
                </div>
            ...
            {value === 'agent' && (
              <>
                <div className='w-4 h-4 p-[1px]'>
                  <CuteRobote className='w-3.5 h-3.5 text-primary-600' />
                </div>
        ...
        <PortalToFollowElemContent className='z-[1002]'>
          <div className='relative p-1 w-[180px] bg-white rounded-xl shadow-2xl'>
            <div className='flex items-center pl-3 py-[6px] pr-2 rounded-lg cursor-pointer hover:bg-gray-100' onClick={() => {
              onChange('chatbot')
              setOpen(false)
            }}>
              <ChatBot className='mr-2 w-4 h-4 text-[#7C3AED]' />
            ...
            <div className='flex items-center pl-3 py-[6px] pr-2 rounded-lg cursor-pointer hover:bg-gray-100' onClick={() => {
              ...
              <CuteRobote className='mr-2 w-4 h-4 text-primary-600' />
