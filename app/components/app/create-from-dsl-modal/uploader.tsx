...
const Uploader: FC<Props> = ({
  ...
  return (
    <div className={cn('mt-6', className)}>
      ...
      <div ref={dropRef}>
        {!file && (
          <div className={cn('flex items-center h-20 rounded-xl bg-gray-100 border-[0.5px] border-dashed border-gray-300 text-sm font-normal', dragging && 'bg-[#F8F4FE] border-[0.5px] border-[#D9C7FA]')}>
            <div className='w-full flex items-center justify-center space-x-2'>
              <UploadCloud01 className='w-6 h-6 mr-2'/>
              <div className='text-gray-500'>
                {t('datasetCreation.stepOne.uploader.button')}
                <span className='pl-1 text-[#681CEA] cursor-pointer' onClick={selectHandle}>{t('datasetDocuments.list.batchModal.browse')}</span>
              </div>
            </div>
        ...
        {file && (
          <div className={cn('flex items-center h-20 px-6 rounded-xl bg-gray-50 border-[0.5px] border-gray-300 text-sm font-normal group', 'hover:bg-[#F8F4FE] hover:border-[#D9C7FA]')}>
