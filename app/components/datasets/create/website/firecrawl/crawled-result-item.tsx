...
const CrawledResultItem: FC<Props> = ({
  ...
  return (
    <div className={cn(isPreview ? 'border-[#D9C7FA] bg-primary-50 shadow-xs' : 'group hover:bg-gray-100', 'rounded-md px-2 py-[5px] cursor-pointer border-[0.5px] border-transparent')}>
