...
const itemClass = `
  flex items-center w-full sm:w-[234px] h-12 px-3 rounded-xl bg-gray-25 border-[0.5px] border-gray-100 cursor-pointer
`
const radioClass = `
  w-4 h-4 border-[2px] border-gray-300 rounded-full
`
