...
`
const labelClass = `
  flex w-[168px] text-sm pt-3
`
const inputClass = `
  w-full max-w-[480px] px-3 bg-gray-200 text-sm text-gray-800 rounded-lg outline-none appearance-none
`
...
const Form = () => {
  ...
  return (
    <div className='w-full sm:w-[800px] p-4 sm:px-12 sm:pt-6 sm:pb-12'>
      <div className={rowClass}>
        ...
        <input
          ...
          className={cn(inputClass, !currentDataset?.embedding_available && 'opacity-60', 'h-11')}
          value={name}
      ...
      <div className={rowClass}>
        ...
        <div className='w-full max-w-[480px]'>
          <textarea
            disabled={!currentDataset?.embedding_available}
            className={cn(`${inputClass} block mb-2 h-[120px] py-3 resize-none`, !currentDataset?.embedding_available && 'opacity-60')}
