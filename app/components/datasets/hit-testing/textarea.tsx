  ...
  return (
    <>
      <div className={s.wrapper}>
        <div className='pt-2 rounded-tl-xl rounded-tr-xl bg-[#F8F4FE]'>
          <div className="px-4 pb-2 flex justify-between h-8 items-center">
            ...
            >
              <div
                ...
                className='flex px-2 h-7 items-center space-x-1 bg-white hover:bg-[#D9C7FA] rounded-md cursor-pointer text-[#6927DA]'
              >
