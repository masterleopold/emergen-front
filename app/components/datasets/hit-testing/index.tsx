...
const RecordsEmpty: FC = () => {
  ...
  return <div className='bg-gray-200 rounded-2xl p-5'>
              ...
              <>
                <div className='grow overflow-y-auto'>
                  <table className={`w-full border-collapse border-0 mt-3 ${s.table}`}>
                    <thead className="sticky top-0 h-8 bg-white leading-8 border-b-[0.5px] border-gray-300 text-gray-500 font-bold">
                      <tr>
                    ...
                    <tbody className="text-gray-500">
                      {recordsRes?.data?.map((record) => {
                        return <tr
                          key={record.id}
                          className='group border-b-[0.5px] border-gray-300 h-12 hover:bg-gray-100 cursor-pointer'
