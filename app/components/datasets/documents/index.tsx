...
const Documents: FC<IDocumentsProps> = ({ datasetId }) => {
  ...
  return (
    <div className='flex flex-col h-full overflow-y-auto'>
      <div className='flex flex-col justify-center gap-1 px-6 pt-6'>
      ...
      <div className='flex flex-col px-6 py-6 flex-1'>
        <div className='flex items-center justify-between flex-wrap pb-2'>
          ...
          <div className='flex gap-2 justify-center items-center !h-8'>
            ...
            {embeddingAvailable && (
              <Button variant='primary' onClick={routeToDocCreate} className='shrink-0 !h-8'>
