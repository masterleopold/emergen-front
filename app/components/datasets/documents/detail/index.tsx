  ...
  return (
    <DocumentContext.Provider value={{ datasetId, documentId, docForm: documentDetail?.doc_form || '' }}>
      <div className='flex flex-col h-full'>
        <div className='flex min-h-16 border-b-gray-300 border-b-[0.5px] items-center p-4 justify-between flex-wrap gap-y-2'>
          <div onClick={backToPrev} className={'shrink-0 rounded-full w-8 h-8 flex justify-center items-center cursor-pointer border-[0.5px] border-transparent hover:border-gray-300'}>
        ...
        <div className='flex flex-row flex-1 justify-between' style={{ height: 'calc(100% - 4rem)' }}>
          {isDetailLoading
            ? <Loading type='app' />
