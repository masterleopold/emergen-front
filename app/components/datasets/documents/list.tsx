  ...
  return <div className='flex items-center' onClick={e => e.stopPropagation()}>
    ...
    {embeddingAvailable && (
      <Popover
        ...
        btnClassName={open => cn(isListScene ? s.actionIconWrapperList : s.actionIconWrapperDetail, open ? '!bg-gray-200 !shadow-none' : '!bg-transparent')}
  ...
  return (
    <div className='w-full h-full overflow-x-auto'>
      <table className={`min-w-[700px] max-w-full w-full border-collapse border-0 text-sm mt-3 ${s.documentTable}`}>
        <thead className="h-8 leading-8 border-b-[0.5px] border-gray-300 text-gray-500 font-medium text-xs uppercase">
          <tr>
            ...
            <td className='w-44'>
              <div className='flex justify-between items-center'>
                ...
                <ArrowDownIcon className={cn('h-3 w-3 stroke-current stroke-2 cursor-pointer', enableSort ? 'text-gray-600' : 'text-gray-400')} onClick={onClickSort} />
              </div>
            </td>
