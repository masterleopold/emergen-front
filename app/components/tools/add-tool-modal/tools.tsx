        ...
        {list.map((tool) => {
          ...
          return (
            <Tooltip
              ...
              position='bottom'
              className='!p-0 !px-3 !py-2.5 !w-[210px] !leading-[18px] !text-xs !text-gray-700 !border-[0.5px] !border-gray-300 !bg-transparent !rounded-xl !shadow-lg translate-x-[108px]'
              htmlContent={(
                <div>
                  <BlockIcon
                    size='md'
            ...
            >
              <div className='group/item flex items-center w-full pl-3 pr-1 h-8 rounded-lg hover:bg-gray-50 cursor-pointer'>
                ...
                {!needAuth && added && (
                  <div className='flex items-center gap-1 rounded-[6px] border-[0.5px] border-gray-100 px-2 py-[3px] bg-white text-gray-300 text-xs font-medium leading-[18px]'>
