      ...
      <div className='mt-2 pt-2 border-t-[0.5px] border-t-black/5'>
        {(!published || !isLoading) && (
          <div className={cn(
            ...
            {isCurrentWorkspaceManager
              ? (
                ...
                >
                  ...
                  {!published && (
                    <span className='shrink-0 px-1 border-[0.5px] border-black/8 rounded-[5px] bg-white text-[10px] font-medium leading-[18px] text-gray-500'>{t('workflow.common.configureRequired').toLocaleUpperCase()}</span>
                  )}
                </div>)
              : (
                <div
            ...
            {published && (
              <div className='px-2.5 py-2 border-t-[0.5px] border-gray-300'>
