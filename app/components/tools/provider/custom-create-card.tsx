...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    return 'https://docs.vox.delivery/tutorials/quick-tool-integration'
  }, [language])
  ...
  return (
    <>
      {isCurrentWorkspaceManager && (
        <div className='flex flex-col col-span-1 bg-gray-100 border-[0.5px] border-gray-300 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-gray-50 hover:shadow-2xl hover:border-transparent'>
          <div className='group grow rounded-t-xl hover:bg-white' onClick={() => setIsShowEditCustomCollectionModal(true)}>
            <div className='shrink-0 flex items-center p-4 pb-3'>
              <div className='w-10 h-10 flex items-center justify-center border-[0.5px] border-gray-300 bg-gray-100 rounded-lg group-hover:border-primary-100 group-hover:bg-primary-50'>
          ...
          <div className='px-4 py-3 rounded-b-xl border-t-[0.5px] border-gray-300 text-gray-500 hover:text-[#7C3AED] hover:bg-white'>
