...
const ProviderDetail = ({
  ...
  return (
    <div className='px-6 py-8'>
      ...
      <div className='flex gap-1 border-b-[0.5px] border-gray-300'>
        {(collection.type === CollectionType.builtIn) && needAuth && (
          <Button
            variant={isAuthed ? 'secondary' : 'primary'}
            className={cn('shrink-0 my-4 w-full', isAuthed && 'bg-white')}
            onClick={() => {
        ...
        {collection.type === CollectionType.custom && !isDetailLoading && (
          <Button
            className={cn('shrink-0 my-4 w-full')}
        ...
        {collection.type === CollectionType.workflow && !isDetailLoading && customCollection && (
          <>
            <Button
              variant='primary'
              className={cn('shrink-0 my-4 w-[183px]')}
            >
        ...
        {!isDetailLoading && (
          <div className='mt-1'>
            ...
            {collection.type === CollectionType.workflow && (customCollection as WorkflowToolProviderResponse)?.tool?.parameters.map(item => (
              <div key={item.name} className='mb-2 px-4 py-3 rounded-xl bg-gray-25 border-[0.5px] border-gray-300'>
