...
const SelectItem: FC<ItemProps> = ({ text, value, isChecked, onClick }) => {
  return (
    <div
      className={cn(isChecked ? 'border-[1px] border-primary-600 bg-white' : 'border border-gray-100', 'mb-2 flex items-center h-9 pl-3 w-[150px] rounded-lg bg-gray-25 hover:bg-gray-50 cursor-pointer space-x-2')}
                ...
                <div>
                  <div className='flex items-center h-8 text-[13px] font-medium text-gray-900'>
                    ...
                    <Tooltip
                      ...
                      htmlContent={
                        <div className='w-[261px] text-gray-500 rounded-lg'>
                  ...
                  <input
                    ...
                    className='w-full h-10 px-3 text-sm font-normal bg-gray-25 rounded-lg grow'
