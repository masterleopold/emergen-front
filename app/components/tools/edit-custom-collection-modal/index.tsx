            ...
            <div className='grow h-0 overflow-y-auto px-6 py-3 space-y-4'>
              <div>
                ...
                <div className='flex items-center justify-between gap-3'>
                  <AppIcon size='large' iconClassName="text-primary-600 w-5" className='!bg-white' />
                  <input
                    className='h-10 px-3 text-sm font-normal bg-gray-25 rounded-lg grow' placeholder={t('tools.createTool.toolNamePlaceHolder')!}
              ...
              <div className='select-none'>
                <div className='flex justify-between items-center'>
                  <div className='flex items-center'>
                    ...
                    <div className='mx-2 w-px h-3 bg-gray-300'></div>
                    <a
                      href="https://swagger.io/specification/"
                      target='_blank' rel='noopener noreferrer'
                      className='flex items-center h-[18px] space-x-1  text-[#7C3AED]'
                    >
                ...
                <textarea
                  ...
                  className='w-full h-[240px] px-3 py-2 leading-4 text-xs font-normal text-gray-900 bg-gray-25 rounded-lg overflow-y-auto'
                ...
                <div className='rounded-lg border-[0.5px] border-gray-300 w-full overflow-x-auto'>
                  <table className='w-full leading-[18px] text-xs text-gray-700 font-normal'>
                    <thead className='text-gray-500 uppercase'>
                      <tr className={cn(paramsSchemas.length > 0 && 'border-b', 'border-gray-300')}>
              ...
              <div>
                ...
                <div className='flex items-center h-9 justify-between px-2.5 bg-gray-25 rounded-lg cursor-pointer' onClick={() => setCredentialsModalShow(true)}>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-gray-25 rounded-lg grow' placeholder={t('tools.createTool.privacyPolicyPlaceholder') || ''} />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-gray-25 rounded-lg grow' placeholder={t('tools.createTool.customDisclaimerPlaceholder') || ''} />
              </div>

            </div>
            <div className={cn(isEdit ? 'justify-between' : 'justify-end', 'mt-2 shrink-0 flex py-4 px-6 rounded-b-[10px] bg-gray-200 border-t-[0.5px] border-gray-300')} >
              {
                isEdit && (
