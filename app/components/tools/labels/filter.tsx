      ...
      <div className='relative'>
        ...
        >
          <div className={cn(
            ...
            !open && !!value.length && '!bg-white/80 shadow-xs !border-gray-300 hover:!bg-gray-200',
            open && !!value.length && '!bg-gray-200 !border-gray-300 hover:!bg-gray-200',
          )}>
            <div className='p-[1px]'>
        ...
        <PortalToFollowElemContent className='z-[1002]'>
          <div className='relative w-[240px] bg-white rounded-xl border-[0.5px] border-gray-300 shadow-2xl'>
