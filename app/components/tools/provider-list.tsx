...
const ProviderList = () => {
  ...
  return (
    <div className='relative flex overflow-hidden bg-gray-25 shrink-0 h-0 grow'>
      <div className='relative flex flex-col overflow-y-auto bg-gray-25 grow'>
        <div className={cn(
          'sticky top-0 flex justify-between items-center pt-4 md:pt-8 px-4 md:px-12 pb-4 leading-[56px] bg-gray-25 z-20 flex-wrap gap-y-2',
        ...
        <div className={cn(
          'relative grid content-start grid-cols-1 gap-4 px-4 md:px-12 pt-2 pb-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 grow shrink-0',
