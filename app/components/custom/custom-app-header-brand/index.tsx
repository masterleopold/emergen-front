  ...
  return (
    <div className='py-3'>
      ...
      <div className='relative mb-4 rounded-xl bg-gray-100 border-[0.5px] border-black/8 shadow-xs'>
        ...
        <div className='flex items-center pl-5 h-14 rounded-t-xl'>
          ...
          <div className='flex items-center mr-3 px-3 h-7 rounded-xl bg-white shadow-xs'>
            <Grid01 className='shrink-0 mr-2 w-4 h-4 text-[#681CEA]' />
            <div className='w-12 h-1.5 rounded-[5px] bg-[#681CEA] opacity-80'></div>
          </div>
        ...
        <div className='h-8 border-t-[0.5px] border-t-gray-200 rounded-b-xl'></div>
      </div>
      <div className='flex items-center mb-2'>
        ...
        <div className='mx-2 h-5 w-[1px] bg-gray-300'></div>
        <Button
          disabled={plan.type === Plan.sandbox}
        >
          {t('custom.restore')}
