...
const CustomWebAppBrand = () => {
  ...
  return (
    <div className='py-4'>
      ...
      <div className='flex items-center justify-between mb-2 px-4 h-14 rounded-xl border-[0.5px] border-gray-300 bg-gray-50 text-sm font-medium text-gray-900'>
      ...
      <div className={`
        flex items-center justify-between px-4 py-3 rounded-xl border-[0.5px] border-gray-300 bg-gray-50
      ...
      `}>
        ...
        <div className='flex items-center'>
          ...
          <div className='mr-2 h-5 w-[1px] bg-gray-300'></div>
          <Button
