...
const Item: FC<ItemProps> = ({
  ...
  return (
    <div
      key={option.value}
      className={cn(className, !isActive && 'cursor-pointer', 'relative pb-2.5  leading-6 text-sm font-semibold')}
...
const TabSlider: FC<Props> = ({
  ...
  return (
    <div className={cn(className, !noBorderBottom && 'border-b-[0.5px] border-[#F4F5F6]', 'flex  space-x-6')}>
      {options.map(option => (
        <Item
