...
const TagItemEditor: FC<TagItemEditorProps> = ({
  ...
  return (
    <>
      <div className={cn('shrink-0 flex items-center gap-0.5 pr-1 pl-2 py-1 rounded-lg border-[0.5px] border-gray-300 text-sm leading-5 text-gray-700')}>
        {!isEditing && (
          <>
            ...
            <div className='group/edit shrink-0 p-1 rounded-md cursor-pointer hover:bg-gray-300' onClick={() => setIsEditing(true)}>
              <RiEditLine className='w-3 h-3 text-gray-500 group-hover/edit:text-gray-800' />
            </div>
            <div className='group/remove shrink-0 p-1 rounded-md cursor-pointer hover:bg-gray-300' onClick={() => {
