  ...
  return (
    ...
    >
      ...
      <div className='mt-3 flex flex-wrap gap-2'>
        <input
          className='shrink-0 w-[100px] px-2 py-1 rounded-lg border-[0.5px] border-dashed border-gray-300 text-sm leading-5 text-gray-700 outline-none appearance-none  placeholder:text-gray-300 caret-primary-600 focus:border-solid'
