...
const NotionPageSelector = ({
  ...
  return (
    <div className='bg-gray-25 border-[0.5px] border-gray-300 rounded-xl'>
      {
        data?.notion_info?.length
          ? (
            <>
              <div className='flex items-center pl-[10px] pr-2 h-11 bg-white border-b-[0.5px] border-b-gray-200 rounded-t-xl'>
                <WorkspaceSelector
