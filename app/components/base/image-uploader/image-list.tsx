  ...
  return (
    <div className="flex flex-wrap">
      {list.map(item => (
        <div
          key={item._id}
          className="group relative mr-2 border-[0.5px] border-gray-300 rounded-lg"
        >
          ...
          <img
            className="w-16 h-16 rounded-lg object-cover cursor-pointer border-[0.5px] border-gray-300"
            alt={item.file?.name}
