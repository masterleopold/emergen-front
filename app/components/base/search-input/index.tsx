...
const SearchInput: FC<SearchInputProps> = ({
  ...
  return (
    <div className={cn(
      'group flex items-center px-2 h-8 rounded-lg bg-gray-200 hover:bg-gray-300 border-[0.5px] border-transparent overflow-hidden',
      focus && '!bg-white hover:bg-white shawdow-xs !border-gray-300',
      !focus && value && 'hover:!bg-gray-200 hover:!shawdow-xs hover:!border-gray-300',
      ...
      <input
        ...
        name="query"
        className={cn(
          'grow block h-[18px] bg-gray-200 rounded-lg border-0 text-gray-700 text-[13px] placeholder:text-gray-500 appearance-none outline-none group-hover:bg-gray-300 caret-primary-600',
