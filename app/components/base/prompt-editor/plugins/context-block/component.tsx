...
const ContextBlockComponent: FC<ContextBlockComponentProps> = ({
  ...
  return (
    <div className={`
      group inline-flex items-center pl-1 pr-0.5 h-6 border-[0.5px] border-transparent bg-[#F4F3FF] text-[#6938EF] rounded-[5px] hover:bg-[#EBE9FE]
          ...
          <PortalToFollowElemContent style={{ zIndex: 100 }}>
            <div className='w-[360px] bg-white rounded-xl shadow-lg'>
              <div className='p-4'>
                ...
                <div className='max-h-[270px] overflow-y-auto'>
                  {
                    localDatasets.map(dataset => (
                      <div key={dataset.id} className='flex items-center h-8'>
                        <div className='flex items-center justify-center shrink-0 mr-2 w-6 h-6 bg-[#F8F4FE] rounded-md border-[0.5px] border-[#EAECF5]'>
                ...
                <div className='flex items-center h-8 text-[#7C3AED] cursor-pointer' onClick={onAddContext}>
