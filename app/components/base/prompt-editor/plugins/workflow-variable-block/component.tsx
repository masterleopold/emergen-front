...
const WorkflowVariableBlockComponent = ({
  ...
  const Item = (
    <div
      className={cn(
        'mx-0.5 relative group/wrap flex items-center h-[18px] pl-0.5 pr-[3px] rounded-[5px] border-[0.5px] select-none',
        isSelected ? ' border-[#84ADFF] bg-[#F8F4FE]' : ' border-gray-300 bg-white',
