...
const HistoryBlockComponent: FC<HistoryBlockComponentProps> = ({
  ...
  return (
    <div className={`
      group inline-flex items-center pl-1 pr-0.5 h-6 border-[0.5px] border-transparent text-[#DD2590] rounded-[5px] hover:bg-[#FCE7F6]
      ...
      >
        ...
        <PortalToFollowElemContent style={{ zIndex: 100 }}>
          <div className='w-[360px] bg-white rounded-xl shadow-lg'>
            ...
            <div
              className='px-4 py-3 text-xs text-[#7C3AED] border-t-[0.5px] border-gray-300 rounded-b-xl cursor-pointer'
              onClick={onEditRole}
            >
