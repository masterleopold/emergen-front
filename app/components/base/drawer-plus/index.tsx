...
const DrawerPlus: FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(contentClassName, 'w-full flex flex-col !bg-gray-200 border-[0.5px] border-gray-300 rounded-xl shadow-xl pb-1')}
        style={{
          height,
        }}
        ref={ref}
      >
        <div className={cn(headerClassName, 'shrink-0 border-b-[0.5px] border-b-gray-400 py-4')}>
          ...
          {titleDescription && (
            <div className='pl-6 pr-10 leading-[18px] text-xs font-normal text-gray-500 pt-2'>
              {titleDescription}
            </div>
          )}
        </div>
