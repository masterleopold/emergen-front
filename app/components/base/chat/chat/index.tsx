  ...
  return (
    ...
    >
      <div className='relative h-full'>
        ...
        <div
          className={`absolute bottom-0 pt-14 rounded-xl ${(hasTryToAsk || !noChatInput || !noStopResponding) && chatFooterClassName}`}
          ref={chatFooterRef}
          style={{
            background: 'linear-gradient(0deg, #FCFDFE 40%, rgba(252, 253, 254, 0.00) 100%)',
          }}
        >
          <div
