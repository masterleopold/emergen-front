...
const WorkflowProcessItem = ({
  ...
  const background = useMemo(() => {
    if (running && !collapse)
      return 'linear-gradient(180deg, #E1E4EA 0%, #F4F5F6 100%)'
  ...
  return (
    <div
      className={cn(
        'mb-4 rounded-lg border-[0.5px] border-black/8',
    ...
    >
      ...
      >
        {
          running && (
            <RiLoader2Line className='shrink-0 mr-1 w-3 h-3 text-[#707B84] animate-spin' />
          )
        }
        {
          succeeded && (
