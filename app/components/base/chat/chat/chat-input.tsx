...
const ChatInput: FC<ChatInputProps> = ({
  ...
  const sendBtn = (
    <div
      className='group flex items-center justify-center w-8 h-8 rounded-lg hover:bg-[#F8F4FE] cursor-pointer'
  ...
  return (
    <>
      <div className='relative'>
        <div
          className={`
            p-2 max-h-[150px] bg-white border-[1.5px] border-gray-300 rounded-xl overflow-y-auto
        ...
        >
          {
            visionConfig?.enabled && (
              <>
                <div className='absolute bottom-[11px] left-3 flex items-center'>
                  <ChatImageUploader
          ...
          <Textarea
            ...
            autoSize
          />
          <div className='absolute bottom-[11px] right-2 flex items-center h-8'>
              ...
              query
                ? (
                  <div className='flex justify-center items-center ml-2 w-8 h-8 cursor-pointer hover:bg-gray-100 rounded-lg' onClick={() => setQuery('')}>
                    <XCircle className='w-4 h-4 text-[#858F97]' />
                  </div>
                )
