...
const ChatWrapper = () => {
          ...
          {!currentConversationId && (
            <div className={cn('mx-auto w-full max-w-[720px] tablet:px-4', isMobile && 'px-4')}>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(90deg, rgba(242, 244, 247, 0.00) 0%, #F8F9F9 49.17%, rgba(242, 244, 247, 0.00) 100%)' }}
              />
            </div>
          )}
        </>
  ...
  return (
    <Chat
      ...
      answerIcon={isEmergen() ? <LogoAvatar className='relative shrink-0' /> : null}
      hideProcessDetail
