  ...
  useEffect(() => {
    ...
    if (site) {
      if (customConfig)
        ...
        document.title = `${site.title} - Powered by Emergen`
    }
  ...
  return (
    <div>
      <Header
        isMobile={isMobile}
        title={site?.title || ''}
        customerIcon={isEmergen() ? emergenIcon : ''}
               ...
               {!isMobile && (
                 <div className='absolute top-2.5 right-3 z-20'>
                   <Tooltip
                     ...
                     position='top'
                   >
                     <div className='p-1.5 bg-white border-[0.5px] border-gray-100 rounded-lg cursor-pointer' onClick={handleNewConversation}>
