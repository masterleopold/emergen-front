  ...
  return (
    <>
      ...
      >
        ...
        {isEditModal && (
          <div className='mb-9 font-semibold text-xl leading-[30px] text-gray-900 pr-6'>{t('app.editAppTitle')}</div>
        )}
        {!isEditModal && (
          <div className='mb-9 font-semibold text-xl leading-[30px] text-gray-900 pr-6'>{t('explore.appCustomize.title', { name: appName })}</div>
        )}
        <div className='mb-9'>
          {/* icon & name */}
          <div className='pt-2'>
          ...
          <div className='pt-2'>
            ...
            <textarea
              className='w-full h-10 px-3 py-2 text-sm font-normal bg-gray-100 rounded-lg border-[0.5px] border-transparent outline-none appearance-none caret-primary-600 placeholder:text-gray-400 hover:bg-gray-50 hover:border hover:border-gray-300 focus:bg-gray-50 focus:border focus:border-gray-300 h-[80px] resize-none'
