...
const AppCard = ({
  ...
  return (
    <div className={cn('group flex col-span-1 border-[0.5px] border-solid border-gray-300 rounded-xl min-h-[160px] flex flex-col transition-all duration-200 ease-in-out cursor-pointer hover:shadow-2xl hover:bg-white hover:border-transparent')}>
