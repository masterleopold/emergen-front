...
const SideBar: FC<IExploreSideBarProps> = ({
  ...
  return (
    <div className='hidden sm:block w-fit sm:w-[216px] shrink-0 pt-8 px-4 cursor-pointer'>
      <div>
        <Link
          href='/explore/apps'
          className={cn(isDiscoverySelected ? 'text-primary-600 font-semibold' : 'text-gray-700 font-medium hover:bg-gray-200', 'flex items-center sm:justify-start sm:w-full justify-center w-fit h-9 sm:px-3 px-2 gap-2 rounded-lg')}
        >
