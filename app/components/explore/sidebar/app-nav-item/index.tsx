...
export default function AppNavItem({
  ...
  return (
    ...
    >
      {isMobile && <AppIcon size='tiny' className='!bg-transparent' iconClassName="w-4 text-primary-600" />}
      {!isMobile && (
        <>
          <div className='flex items-center space-x-2 w-0 grow'>
            <AppIcon size='tiny' className='!bg-transparent' iconClassName="w-4 text-primary-600" />
