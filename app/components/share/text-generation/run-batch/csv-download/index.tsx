  ...
  return (
    <div className='mt-6'>
      ...
      <div className='mt-2 max-h-[500px] overflow-auto'>
        <table className='w-full border-separate border-spacing-0 border-[0.5px] border-gray-300 rounded-lg text-xs'>
          <thead className='text-gray-500'>
            <tr>
              {addQueryContentVars.map((item, i) => (
                <td key={i} className='h-9 pl-4 border-b-[0.5px] border-gray-300'>{item.name}</td>
              ))}
            </tr>
          </thead>
