  ...
  useEffect(() => {
    if (siteInfo?.title) {
      if (canReplaceLogo)
        ...
        document.title = `${siteInfo.title} - Powered by Emergen`
    }
        ...
        <div className={cn(
          ...
          <div className='mb-6'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-3'>
                <AppIcon size="small" iconClassName="text-primary-600 w-5" className='!bg-transparent' />
              ...
              ...(!isWorkflow
                ? [{
                  ...
                  extra: savedMessages.length > 0
                    ? (
                      <div className='ml-1 flext items-center h-5 px-1.5 rounded-md border-[0.5px] border-gray-300 text-gray-500 text-xs font-medium'>
