...
const AnnotationFull: FC = () => {
  ...
  return (
    <GridMask wrapperClassName='rounded-lg' canvasClassName='rounded-lg' gradientClassName='rounded-lg'>
      <div className='mt-6 px-3.5 py-4 border-2 border-solid border-transparent rounded-lg flex flex-col transition-all duration-200 ease-in-out cursor-pointer'>
