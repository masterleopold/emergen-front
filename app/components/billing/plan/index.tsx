...
const typeStyle = {
  [Plan.sandbox]: {
    ...
    bg: 'linear-gradient(113deg, rgba(255, 255, 255, 0.51) 3.51%, rgba(255, 255, 255, 0.00) 111.71%), #F4F5F6',
  },
  [Plan.professional]: {
  ...
  [Plan.team]: {
    ...
    bg: 'linear-gradient(113deg, rgba(255, 255, 255, 0.51) 3.51%, rgba(255, 255, 255, 0.00) 111.71%), #F8F4FE',
  },
  [Plan.enterprise]: {
...
const PlanComp: FC<Props> = ({
  ...
  return (
    <div
      className='rounded-xl border-[0.5px] border-white select-none'
      style={{
