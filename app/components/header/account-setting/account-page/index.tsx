...
const inputClassName = `
  mt-2 w-full px-4 py-3 bg-gray-200 rounded-lg
  ...
  return (
    <>
      ...
      <div className='mb-8'>
        ...
        <div className={classNames('flex items-center justify-between mt-2 w-full h-11 px-4 bg-gray-200 rounded-lg text-sm font-normal text-gray-800 cursor-pointer group')}>
          {userProfile.name}
          <div className='items-center hidden h-6 px-2 text-xs font-normal bg-white border-[0.5px] border-gray-300 rounded-md group-hover:flex' onClick={handleEditName}>{t('common.operation.edit')}</div>
        </div>
      </div>
      <div className='mb-8'>
      ...
      {showDeleteAccountModal && (
        ...
        >
          ...
          <div className='mt-3 text-sm leading-5'>
            ...
            <a className='text-primary-600 cursor' href={`mailto:a@vox.delivery?subject=Delete Account Request&body=Delete Account: ${userProfile.email}`} target='_blank'>a@vox.delivery</a>
          </div>
