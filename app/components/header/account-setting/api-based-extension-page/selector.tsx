  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)} className='w-full'>
        {
          currentItem
            ? (
              <div className='flex items-center justify-between pl-3 pr-2.5 h-11 bg-gray-200 rounded-lg cursor-pointer'>
            ...
            : (
              <div className='flex items-center justify-between pl-3 pr-2.5 h-11 bg-gray-200 rounded-lg text-sm text-gray-400 cursor-pointer'>
      ...
      <PortalToFollowElemContent className='w-[calc(100%-32px)] max-w-[576px] z-[102]'>
        <div className='w-full rounded-lg border-[0.5px] border-gray-300 bg-white shadow-lg z-10 focus-visible:outline-none'>
          <div className='p-1'>
