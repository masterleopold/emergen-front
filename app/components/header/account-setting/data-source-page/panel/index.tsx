...
const Panel: FC<Props> = ({
  ...
  return (
    <div className='mb-2 border-[0.5px] border-gray-300 bg-gray-50 rounded-xl'>
      <div className='flex items-center px-3 py-[9px]'>
        <div className={cn(s[`${type}-icon`], 'w-8 h-8 mr-3 border-[0.5px] border-gray-100 rounded-lg')} />
        <div className='grow'>
          <div className='flex items-center h-5'>
            <div className='text-sm font-medium text-gray-800'>{t(`common.dataSource.${type}.title`)}</div>
            {isWebsite && (
              <div className='ml-1 leading-[18px] px-1.5 rounded-md bg-white border-[0.5px] border-gray-100 text-xs font-medium text-gray-700'>
          ...
          <>
            {
              isConfigured
                ? (
                  <div
                    className={
                      `flex items-center ml-3 px-3 h-7 bg-white border-[0.5px] border-gray-300
                ...
                : (
                  <>
                    {isSupportList && <div
                      className={
                        `flex items-center px-3 py-1 min-h-7 bg-white border-[0.5px] border-gray-300 text-xs font-medium text-primary-600 rounded-md
                  ${!readOnly ? 'cursor-pointer' : 'grayscale opacity-50 cursor-default'}`
                      }
                      onClick={onConfigure}
                    >
        ...
        isConfigured && (
          <>
            <div className='flex items-center px-3 h-[18px]'>
              ...
              <div className='grow ml-3 border-t-[0.5px] border-t-gray-100' />
            </div>
