      ...
      <Panel
        ...
        configuredList={sources.map(item => ({
          ...
          logo: ({ className }: { className: string }) => (
            <div className={cn(className, 'flex items-center justify-center w-5 h-5 bg-white border-[0.5px] border-gray-100 text-xs font-medium text-gray-500 rounded ml-3')}>🔥</div>
          ),
          name: 'FireCrawl',
          isActive: true,
        }))}
