  ...
  return (
    <>
      <div className='flex flex-col'>
        <div className='flex items-center mb-4 p-3 bg-gray-100 rounded-2xl'>
          ...
          <div className={
            `shrink-0 flex items-center py-[7px] px-3 border-[0.5px] border-gray-300
            text-[13px] font-medium text-primary-600 bg-white
             rounded-lg ${(isCurrentWorkspaceManager && !isMemberFull) ? 'cursor-pointer' : 'grayscale opacity-50 cursor-default'}`
        ...
        <div className='overflow-visible lg:overflow-visible'>
          <div className='flex items-center py-[7px] border-b-[0.5px] border-gray-300 min-w-[480px]'>
          ...
          <div className='min-w-[480px] relative'>
            {
              accounts.map(account => (
                <div key={account.id} className='flex border-b-[0.5px] border-gray-300'>
