  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)}>
        <div className={`
          flex items-center px-2 text-xs text-gray-700 cursor-pointer bg-white rounded-md border-[0.5px] border-gray-300
          hover:bg-gray-100 py-2
          ${open && 'bg-gray-100 shadow-none'}
        `}>
          <Settings01 className='mr-2 w-3 h-3 text-gray-500' />
          {t('common.modelProvider.systemModelSettings')}
        </div>
      </PortalToFollowElemTrigger>
      <PortalToFollowElemContent className='z-50'>
        <div className='pt-4 w-[360px] rounded-xl border-[0.5px] border-gray-300 bg-white shadow-xl'>
