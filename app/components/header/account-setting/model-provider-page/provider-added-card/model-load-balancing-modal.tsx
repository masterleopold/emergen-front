            ...
            <div className='py-2'>
              <div
                className={classNames(
                  ...
                  draftConfig.enabled ? 'border-gray-300 cursor-pointer' : 'border-primary-400 cursor-default',
                )}
              ...
              >
                <div className='flex items-center px-[15px] py-3 gap-2 select-none'>
                  <div className='grow-0 shrink-0 flex items-center justify-center w-8 h-8 bg-white border-[0.5px] rounded-lg'>
                    {Boolean(model) && (
