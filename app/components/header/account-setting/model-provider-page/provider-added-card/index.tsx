...
const ProviderAddedCard: FC<ProviderAddedCardProps> = ({
  ...
  return (
    <div
      className='mb-2 rounded-2xl border-[0.5px] border-gray-300'
      style={{ background: provider.background || DEFAULT_BACKGROUND_COLOR }}
    >
      <div className='flex p-3 rounded-t-xl'>
      ...
      {
        collapsed && (
          <div className='group flex items-center justify-between px-3 py-2 border-t-[0.5px] border-t-black/5 bg-white/30 text-xs font-medium text-gray-500'>
