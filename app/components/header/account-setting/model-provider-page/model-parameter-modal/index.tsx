    ...
    >
      <div className='relative'>
        ...
        <PortalToFollowElemContent className={cn(portalToFollowElemContentClassName, 'z-[60]')}>
          <div className={cn(popupClassName, 'w-[496px] rounded-xl border-[0.5px] border-gray-100 bg-white shadow-2xl')}>
            <div className={cn(
            ...
            {!hideDebugWithMultipleModel && (
              <div
                className='flex items-center justify-between px-6 h-[50px] bg-gray-100 border-t-[0.5px] border-t-gray-100 text-xs font-medium text-primary-600 cursor-pointer rounded-b-xl'
