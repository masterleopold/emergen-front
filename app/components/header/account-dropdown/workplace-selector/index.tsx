...
const itemIconClassName = `
  shrink-0 mr-2 flex items-center justify-center w-6 h-6 bg-[#F8F4FE] rounded-md text-xs font-medium text-primary-600
`
          ...
          <>
            <Menu.Button className={cn(
              `
                ...
                group hover:bg-gray-100 cursor-pointer ${open && 'bg-gray-100'} rounded-lg
              `,
            )}>
