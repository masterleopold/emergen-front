              ...
              <div>
                <Menu.Button
                  className={`
                    ...
                    rounded-[20px] py-1 pr-1 text-sm
                ...
                >
                  ...
                  <Avatar name={userProfile.name} className='sm:ml-3 ml-0' size={32} />
                </Menu.Button>
              </div>
              <Transition
                as={Fragment}
              ...
              >
                <Menu.Items
                  className="
                    ...
                    shadow-2xl focus-visible:outline-none
                  "
                >
                  <Menu.Item>
                  ...
                  <div className="hidden sm:block px-1 py-1">
                    <Menu.Item>
                    ...
                    <Menu.Item>
                      <Link
                        ...
                        href='https://discord.gg/b9GqFq57p8'
