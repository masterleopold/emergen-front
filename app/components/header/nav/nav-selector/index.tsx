                    ...
                    <Menu.Item key={nav.id}>
                      <div className='flex items-center w-full px-3 py-[6px] text-gray-700 text-[14px] rounded-lg font-normal hover:bg-gray-100 cursor-pointer truncate' onClick={() => {
                        ...
                        <div className='relative w-6 h-6 mr-2 rounded-md'>
                          ...
                          {!!nav.mode && (
                            <span className={cn(
                              'absolute w-3.5 h-3.5 -bottom-0.5 -right-0.5 p-0.5 bg-white rounded border-[0.5px] border-[rgba(0,0,0,0.02)]',
                            )}>
              ...
              {!isApp && isCurrentWorkspaceEditor && (
                <Menu.Button className='p-1 w-full'>
                  <div onClick={() => onCreate('')} className={cn(
                    ...
                    <div className='shrink-0 flex justify-center items-center w-6 h-6 bg-gray-50 rounded-[6px] border-[0.5px] border-gray-300 border'>
                    ...
                    <>
                      ...
                      >
                        <Menu.Items className={cn(
                          'absolute top-[3px] right-[-198px] min-w-[200px] z-10 bg-white border-[0.5px] border-gray-300 rounded-lg shadow-lg',
                        )}>
                          <div className='p-1'>
                          ...
                          <div className='p-1 border-t-[0.5px] border-gray-100'>
