            ...
            <div className="mb-4">
              ...
              <div className="mt-1 relative rounded-md">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border-[0.5px] border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                />
              </div>
            </div>
