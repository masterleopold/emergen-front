...
const Apps = () => {
  ...
  useEffect(() => {
    document.title = `${t('common.menus.apps')} -  Emergen`
  ...
  return (
    <>
      <div className='sticky top-0 flex justify-between items-center pt-4 md:pt-8 px-4 md:px-12 pb-4 leading-[60px] bg-gray-25 z-10 flex-wrap gap-y-2'>
        <TabSliderNew
          value={activeTab}
      ...
      <nav className='grid content-start grid-cols-1 gap-4 px-4 md:px-12 pt-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 grow shrink-0'>
