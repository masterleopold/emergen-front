...
const AppDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (appDetail) {
      document.title = `${(appDetail.name || 'App')} - Emergen`
  ...
  return (
    <div className={cn(s.app, 'flex', 'overflow-hidden', 'border-t-[0.5px]', 'border-gray-300')}>
      {appDetail && (
      ...
      <div className="bg-gray-25 grow overflow-hidden">
        {children}
      </div>
    </div>
  )
