    ...
    <>
      ...
      >
        <div className='flex pt-[14px] px-[14px] pb-3 h-[66px] items-center gap-3 grow-0 shrink-0'>
          <div className={cn(
            'shrink-0 flex items-center justify-center p-2.5 bg-[#F8F4FE] rounded-md border-[0.5px] border-[#F8F4FE]',
            !dataset.embedding_available && 'opacity-50 hover:opacity-100',
          )}>
            <Folder className='w-5 h-5 text-[#681CEA]' />
          </div>
          <div className='grow w-0 py-[1px]'>
            <div className='flex items-center text-sm leading-5 font-semibold text-gray-800'>
              ...
              {!dataset.embedding_available && (
                ...
                >
                  <span className='shrink-0 inline-flex w-max ml-1 px-1 border-[0.5px] boder-gray-200 rounded-md text-gray-500 text-xs font-normal leading-[18px]'>{t('dataset.unavailable')}</span>
                </Tooltip>
              )}
            </div>
        ...
        <div className={cn(
          'items-center shrink-0 mt-1 pt-1 pl-[6px] pr-[6px] pb-[6px] h-[42px]',
          ...
          <div className='!hidden group-hover:!flex shrink-0'>
            <CustomPopover
              ...
              btnClassName={open =>
                cn(
                  open ? '!bg-gray-300 !shadow-none' : '!bg-transparent',
                  'h-8 w-8 !p-2 rounded-md border-none hover:!bg-gray-300',
                )
              }
