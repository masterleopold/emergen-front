...
const Container = () => {
  ...
  return (
    <div ref={containerRef} className='grow relative flex flex-col bg-gray-25 overflow-y-auto'>
      <div className='sticky top-0 flex justify-between pt-4 md:pt-8 px-4 md:px-12 pb-4 leading-[56px] bg-gray-25 z-10 flex-wrap gap-y-2'>
        <TabSliderNew
          value={activeTab}
