...
const CreateAppCard = forwardRef<HTMLAnchorElement>((_, ref) => {
  ...
  return (
    <a ref={ref} className='group flex flex-col col-span-1 bg-gray-100 border-[0.5px] border-gray-300 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-white hover:shadow-2xl' href='/datasets/create'>
