const translation = {
  ...
  welcome: 'Welcome to Emergen! Please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Emergen Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Emergen',
  invalid: 'The link has expired',
  explore: 'Explore Emergen',
