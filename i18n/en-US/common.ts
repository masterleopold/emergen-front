const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Emergen account',
    langGeniusAccountTip: 'Your Emergen account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Emergen to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Emergen allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Emergen\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.vox.delivery/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Emergen {{version}} is now available.',
    latestAvailable: 'Emergen {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
