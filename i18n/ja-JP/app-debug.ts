const translation = {
  ...
  feature: {
    ...
    dataSet: {
      title: 'コンテキスト',
      noData: 'コンテキストとしてナレッジをインポートできます',
      words: '単語',
      textBlocks: 'テキストブロック',
      selectTitle: '参照するナレッジを選択',
      selected: '選択されたナレッジ',
      noDataSet: 'ナレッジが見つかりません',
      toCreate: '作成に進む',
      notSupportSelectMulti: '現在、複数のナレッジの選択はサポートされていません',
      queryVariable: {
        title: 'クエリ変数',
        ...
        unableToQueryDataSet: 'ナレッジをクエリできません',
        unableToQueryDataSetTip: 'ナレッジのクエリに失敗しました。正常にクエリできなかった場合は、コンテキストセクションでコンテキストクエリ変数を選択してください。',
        ok: 'OK',
        contextVarNotEmpty: 'コンテキストクエリ変数は空にできません',
        deleteContextVarTitle: '変数 "{{varName}}" を削除しますか？',
        deleteContextVarTip: 'この変数はコンテキストクエリ変数として設定されており、削除するとナレッジの正常な使用に影響します。削除する場合は、コンテキストセクションで再選択してください。',
      },
    },
    tools: {
      title: 'ツール',
  ...
  automatic: {
    ...
    description: 'シナリオを説明してください。Emergenがアプリケーションをあなたのためにオーケストレートします。',
